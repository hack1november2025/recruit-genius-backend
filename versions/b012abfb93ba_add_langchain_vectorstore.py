...
def upgrade() -> None:
    ...
    # Create collection table only if it doesn't exist
    if 'langchain_pg_collection' not in inspector.get_table_names():
        op.create_table(
    ...
    # Create embedding table with vector column only if it doesn't exist
